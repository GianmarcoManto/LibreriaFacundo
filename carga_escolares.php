...
<body class="container" ; background=  "img/fondo1.jpg" ;  style=" background-size: cover;">
    ...
    <div class="alert alert-primary" align="center" role="alert">CARGAR ARTICULO ESCOLAR</div>
    ...
    <div class="row"  style="background-color: RGB(255, 160, 122); ">
        ...
        <div class="col-8">
            <form action="carga_escolares_sql.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="marca" name="marca" placeholder="Bic, Maped, Pizzini..." class="form-control">
                </div> 
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="stock" name="stock" placeholder="Ingresar la cantidad de productos que hay en stock" class="form-control">
                </div> 
