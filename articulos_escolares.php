...
<body class="container" ; background=  "img/fondo1.jpg" ;  >
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item active" data-interval="10000">
      <img src="img/11.jpg" class="d-block w-100" height = "300px" alt="...">
    </div>
    <div class="carousel-item" data-interval="2000">
      <img src="img/maped.jpg" class="d-block w-100" height = "300px" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/lapiz.jpg" class="d-block w-100" height = "300px" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/sharpie.jpg" class="d-block w-100" height = "300px" alt="...">
    </div>
  </div>
            ...
            echo '<div class="card">';
              ...
              echo '<div class="card-body">';
                ...
                echo '<form action="carritoPost.php" method="post">';
                  echo '<input type="hidden" id="tipo" name="tipo" value="escolares"></input>';
