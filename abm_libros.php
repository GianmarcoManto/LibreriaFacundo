                ...
                <table class="table table-bordered table-sm table-hover table table table-striped table-dark">
                    <thead>
                        <tr style="background: #005545; color: white" class="text-center">
                            <td>Producto</td><td>Stock</td><td>Editorial</td><td>Autor</td><td>Precio</td><td>Imagen</td><td>Acciones</td>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        while($z = mysqli_fetch_array($resultado1)){
                            if($z['borrar'] == 0){
                                ...
                                echo "<td class='text-center'>".$z['editorial']."</td>";
                                echo "<td class='text-center'>".$z['autor']."</td>";
                                ...
                                echo "<td>
                                        <a href='editar_libro.php?producto=".$z['producto']."
                                        &stock=".$z['stock']."
                                        &editorial=".$z['editorial']."
                                        &autor=".$z['autor']."
                                        &precio=".$z['precio']."
                                        ' >Editar</a>
                                        ||
                                        <a href='borrar_libro.php?producto=".$z['producto']."
                                        &stock=".$z['stock']."
                                        &editorial=".$z['editorial']."
                                        &autor=".$z['autor']."
                                        &precio=".$z['precio']."
