                ...
                <table class="table table-bordered table-sm table-hover table table table-striped table-dark">
                    <thead>
                        <tr style="background: #005545; color: white" class="text-center">
                            <td>Producto</td><td>Marca</td><td>Stock</td><td>Precio</td><td></td><td>Acciones</td>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        while($z = mysqli_fetch_array($resultado1)){
                            if($z['borrar'] == 0){
                                ...
                                echo "<td>
                                        <a href='editar_producto.php?producto=".$z['producto']."
                                        &marca=".$z['marca']."
                                        &stock=".$z['stock']."
                                        &precio=".$z['precio']."
                                        '>Editar</a>
                                        ||
                                        <a href='borrar_producto.php?producto=".$z['producto']."
                                        &marca=".$z['marca']."
                                        &precio=".$z['precio']."
                                        '>Borrar</a>
                                      </td>";
