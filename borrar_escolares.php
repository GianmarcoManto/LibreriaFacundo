...
<body class="container">
    ...
    <div class ="alert alert-dark" role= "alert">
        <h5 class="text-center">Baja de Articulos Escolares.</h5>
     </div>
     ...
     <div class="container">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <form action="borrar_escolares_sql.php" method="post">
                    ...
                    <button type="submit" class="btn btn-primary btn-block" name="boton" value=1>Eliminar Articulo Escolar</button>
