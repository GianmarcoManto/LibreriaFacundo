...
<body class="container" ; background=  "img/fondo1.jpg" ;  >
  ...
  <div class="carousel-inner">
    <div class="carousel-item active" data-interval="10000">
      <img src="img/libro.jpg" class="d-block w-100" height = "300px" alt="...">
    </div>
    <div class="carousel-item" data-interval="2000">
      <img src="img/libroo.jpg" class="d-block w-100" height = "300px" alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/librooo.jpg" class="d-block w-100" height = "300px"  alt="...">
    </div>
    <div class="carousel-item">
      <img src="img/libroooo.jpg" class="d-block w-100" height = "300px" alt="...">
    </div>
  </div>
          ...
          echo '<div class="col-sm-3">';
            ...
            echo '<div class="card">';
              ...
              echo '<div class="card-body">';
                ...
                echo "<h6 class='card-subtitle mb-2 text-muted'>Marca: ".$z['autor']."</h6>";
