...
<body class="container" ; background=  "img/fondo1.jpg" ;  style=" background-size: cover;">
    ...
    <div class="alert alert-primary" align="center" role="alert">ABM LIBROS </div>
    ...
    <div class="row"  style="background-color: RGB(255, 160, 122); ">
        ...
        <div class="col-8">
            <form action="editar_libro_sql.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="marca">Autor</label>
                        <input type="text" id="autor" name="autor" value="<?php echo $autor; ?>" class="form-control">
                </div> 
                <div class="form-group">
                    <label for="marca">Editorial</label>
                        <input type="text" id="editorial" name="editorial" value="<?php echo $editorial; ?>" class="form-control">
                </div> 
                <div class="form-group">
